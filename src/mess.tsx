    ...
    if (e.key === " ") {  // spacebar
      ...
      async function endTranscript() {
        ...
        try {
          ...
          if (data && data.speaker && data.verdict && data.explanation) {
            ...
            console.log("Dispatched gemini-fact-check event with:", data);
          } else {
            console.error("Invalid fact-check response format:", data);
          }
        } catch (err) {
