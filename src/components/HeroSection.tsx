...
const HeroSection = () => {
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              ...
              if (textReaderSection) {
                textReaderSection.scrollIntoView({
                  behavior: 'auto',
                  block: 'start'
                });
              }
  ...
  return <>
      <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="text-center z-10 px-8" style={{
        opacity: textOpacity,
        transform: `scale(${textScale})`,
        transition: 'all 0.1s ease-out'
      }}>
          <h1 className="text-6xl md:text-8xl font-pixel mb-8 text-white drop-shadow-lg" style={{
...
Debate Game
      ...
      {finalResult !== null && !showModal && <div className="fixed top-6 right-6 z-50 animate-fade-in">
          <div className={`px-4 py-2 rounded-full border-2 font-bold text-lg shadow-lg ${finalResult ? 'bg-green-500/20 text-green-400 border-green-500 shadow-green-500/25' : 'bg-red-500/20 text-red-400 border-red-500 shadow-red-500/25'}`}>
      ...
      {showModal && <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm animate-fade-in">
          <div className="bg-background/95 backdrop-blur-md rounded-2xl p-12 border border-border shadow-2xl max-w-md w-full mx-4 animate-scale-in">
            <div className="text-center">
              ...
              <div className="mb-8">
                <div className={`inline-block px-12 py-6 rounded-2xl text-6xl font-bold font-pixel border-4 transition-all duration-200 ease-in-out ${flashingValue ? 'bg-green-500/20 text-green-400 border-green-500' : 'bg-red-500/20 text-red-400 border-red-500'}`} style={{
              imageRendering: 'pixelated'
            }}>
